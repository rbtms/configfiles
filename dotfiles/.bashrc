...
# Enable case insensitivity for completion
...
alias litterbox="cat /usr/bin/scripts/catbox.py | python3 - litterbox"
...
## Shell scripts
alias profile='/usr/bin/scripts/profile.sh'
alias cleanall="/usr/bin/scripts/clean.sh"
alias ffbackup="/usr/bin/scripts/ffbackup.sh"
alias publicip="/usr/bin/scripts/get_public_ip.sh"
...
# Add npm local global folder to the PATH
export PATH=$PATH:~/.npm/global/bin

# Other path exports
export SCRIPTS=/usr/bin/scripts
